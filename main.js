...
function draw() {
  ...
  else if (currentScreen === "success") drawSuccess();
  else if (currentScreen === "failure") drawFailure();
}
...
function mousePressed() {
  ...
  else if (currentScreen === "success") successMousePressed?.();
  else if (currentScreen === "failure") failureMousePressed?.();
}
...
function keyPressed() {
  ...
  else if (currentScreen === "success") successKeyPressed?.();
  else if (currentScreen === "failure") failureKeyPressed?.();
}
